...
var hospitals = [
  ...
  new Hospital({
    ...
    address:
      'Surya Mandir Road, Near Sun Temple, Opposite Mahaveer Residency, Gwalior, Madhya Pradesh',
  ...
  new Hospital({
    ...
    address:
      '18, Kila Gate Road, Vikas Nagar, Near Sai Baba Mandir, Gwalior, Madhya Pradesh',
  ...
  new Hospital({
    ...
    address:
      '19 A, Vijay Nagar Extension, Basant Vihar Colony, Lashkar, Gwalior, Madhya Pradesh',
    contact: '09926800870',
    city: 'Gwalior',
    img: 'sahara.jpg',
  }),
  new Hospital({
    ...
    address:
      '22, 2A, Mundhwa - Kharadi Rd, Near Nyati Empire, Santipur, Thite Nagar, Kharadi, Pune, Maharashtra',
